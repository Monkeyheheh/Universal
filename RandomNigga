...
return Kavo
local Window = Library.CreateLib("Random nigga", "BloodTheme")

local HomeTab = Window:NewTab("Home")
local HomeSection = HomeTab:NewSection("Home")

HomeSection:NewButton("Infinite yield", "x0", function()
...
HomeSection:NewButton("Multi Scripter X", "x0", function()
